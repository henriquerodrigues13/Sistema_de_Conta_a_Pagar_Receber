...
def backup_sqlite():
    ...
    backup_db = Path(__file__).parent.parent.parent.parent / 'Trabalho(CPR)_logs_backup' / 'Backup'
...
def enviar_backup():
    backup_dir = Path(__file__).parent.parent.parent.parent / 'Trabalho(CPR)_logs_backup' / 'Backup'
