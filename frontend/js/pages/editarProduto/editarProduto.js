            ...
            <form id="form-editarProduto">
                ...
                <div class="campo">
                    ...
                    <select id="editar-status-produto">
                        <option value="ativo" ${produto.status_do_produto === 'ativo' ? 'selected' : ''}>Ativo</option>
                        <option value="indisponivel" ${produto.status_do_produto === 'indisponivel' ? 'selected' : ''}>Indisponível</option>
                    </select>
                </div>
