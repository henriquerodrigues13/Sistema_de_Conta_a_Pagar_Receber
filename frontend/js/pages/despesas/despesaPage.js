function paginaDespesa(){
    return`
        ...
        <input type="text" placeholder="Pesquisar receita" id="input-pesquisarDespesa">
        ...
        <div id="baixo-sectionDespesa">
            <button type="button" id="btn-adicionarDespesa" onclick="renderizarPagina('cadastroDespesa')">+ Cadastrar Despesa</button>
