/**
 * Gera o HTML da página de listagem de receitas.
    ...
    return `
        <div id="container-receita">
            ...
            <div id="baixo-sectionReceita">
                <button type="button" id="btn-adicionarReceita" onclick="renderizarPagina('cadastroReceita')">
                    + Cadastrar Receita
                </button>
                <p id="total-receitas">
                    Total de Receitas: <span id="span-total">0</span>
                </p>
            </div>
